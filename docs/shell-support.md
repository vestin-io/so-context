...
- [src/shell/patterns/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/mod.rs)

Implementations:

- [src/shell/patterns/git/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/git/mod.rs)
- [src/shell/patterns/docker/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/docker/mod.rs)
- [src/shell/patterns/node/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/node/mod.rs)
- [src/shell/patterns/rust/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/rust/mod.rs)
- [src/shell/patterns/gh/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/gh/mod.rs)
- [src/shell/patterns/k8s/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/k8s/mod.rs)
- [src/shell/patterns/build/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/build/mod.rs)
- [src/shell/patterns/generic/mod.rs](/Users/jiatwork/Works/so-context/src/shell/patterns/generic/mod.rs)
...
- Shell execution now uses bounded buffered capture with timeout/truncation markers, but it is still not true streaming summarization
